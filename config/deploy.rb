...
set :user, "root"
#set :use_sudo, 'true'
set :password, "V8HrUnOqw3"
set :application, "booksh"

set :rvm_ruby, "ruby-2.0.0-p247"
set :rvm_ruby_string, "ruby-2.0.0-p247@booksh"
...
set :copy_exclude, ['public/system/*']
...
set :deploy_to, "/var/sites/booksh/"

desc "Fix file permissions"
task :fix_file_permissions, :roles => [ :app, :db, :web ] do
	run "#{try_sudo} chown -R www-data:www-data #{current_path}/"
end
